...
## Setup
Adding the DLL file references via Visual Studios does not appear to work.

Instead, you will need to edit the .csproj file to include the NuGet packages:
	<PackageReference Include="DarkRift" Version="2.11.0" />
	<PackageReference Include="DarkRift.Client" Version="2.11.0" />
	<PackageReference Include="DarkRift.Server" Version="2.11.0" />
